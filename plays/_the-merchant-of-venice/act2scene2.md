...
succ: act-2-scene-3
text:
  - os: "Enter LAUNCELOT the clown, alone"
    ms: "LAUNCELOT enters alone."
  ...
  - os: "Enter Old GOBBO with a basket"
    ms: "GOBBO enters with a basket."
  ...
  - os: "Enter BASSANIO with LEONARDO and another follower or two"
    ms: "BASSANIO enters with LEONARDO and an attendant or two."
  ...
  - os: "Exit LAUNCELOT the clown with Old GOBBO"
    ms: "LAUNCELOT and GOBBO exit."
