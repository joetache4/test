...
succ: act-1-scene-3
text:
  - os: "Flourish Enter CAESAR, ANTONY, dressed for the course, CALPHURNIA, PORTIA, DECIUS, CICERO, BRUTUS, CASSIUS, CASCA, and a SOOTHSAYER in a throng of plebians. After them, MURELLUS and FLAVIUS"
    ms: "A trumpet sounds. CAESAR enters, followed by ANTONY, dressed formally for a foot race, then CALPHURNIA, PORTIA, DECIUS, CICERO, BRUTUS, CASSIUS, and CASCA. A great crowd follows, among them a SOOTHSAYER."
  ...
  - os: "SOOTHSAYER approaches"
    ms: "The SOOTHSAYER approaches."
  ...
  - os: "Sennet. Exeunt. Manent BRUTUS and CASSIUS"
    ms: "Trumpets play. Everyone exits except BRUTUS and CASSIUS."
  ...
  - os: "Flourish, and shout within"
    ms: "Trumpets play offstage, and then a shout is heard."
  ...
  - os: "Shout within. Flourish"
    ms: "A shout offstage. Trumpets play."
  ...
  - os: "Enter CAESAR and his train, which includes CASCA"
    ms: "CAESAR enters with his followers, who include CASCA."
  ...
  - os: "During the exchange between CAESAR and ANTONY, BRUTUS pulls CASCA by the sleeve"
    ms: "During the exchange between CAESAR and ANTONY, BRUTUS pulls CASCA by the sleeve."
  ...
  - os: "Sennet. Exeunt CAESAR and all his train except CASCA"
    ms: "Trumpets play. CAESAR exits with all his followers except CASCA."
