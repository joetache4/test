...
succ: act-4-scene-7
text:
  - os: "Enter GLOUCESTER, and EDGAR disguised in peasant clothing"
    ms: "GLOUCESTER enters with EDGAR, who is dressed as a peasant."
  ...
  - os: "EDGAR moves aside"
    ms: "EDGAR moves aside."
  ...
  - os: "Enter GENTLEMAN with two others"
    ms: "The GENTLEMAN enters with two other gentlemen."
  ...
  - os: "Exit LEAR running, followed by two gentlemen"
    ms: "LEAR exits running, chased by two gentlemen."
  ...
  - os: "EDGAR interferes"
    ms: "EDGAR steps in between GLOUCESTER and OSWALD."
  ...
  - os: "EDGAR and OSWALD fight"
    ms: "EDGAR and OSWALD fight."
