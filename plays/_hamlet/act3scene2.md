...
succ: act-3-scene-3
text:
  - os: "Enter HAMLET and PLAYERS"
    ms: "HAMLET and the PLAYERS enter."
  ...
  - os: "Enter POLONIUS, ROSENCRANTZ, and GUILDENSTERN"
    ms: "POLONIUS, GUILDENSTERN, and ROSENCRANTZ enter."
  ...
  - os: "Exeunt ROSENCRANTZ and GUILDENSTERN"
    ms: "ROSENCRANTZ and GUILDENSTERN exit."
  ...
  - os: "Danish march. Sound a flourish. Enter King CLAUDIUS, Queen GERTRUDE, POLONIUS, OPHELIA, ROSENCRANTZ, GUILDENSTERN and other lords attendant with CLAUDIUS's; guard carrying torches"
    ms: "Trumpets play. CLAUDIUS enters with GERTRUDE, POLONIUS, OPHELIA, ROSENCRANTZ, GUILDENSTERN, and other lords attendant with CLAUDIUS 's guard carrying torches."
  ...
  - c: HAMLET
    ...
    m:
      - "No thanks, my good mother. There's a nicer piece of work right here. *(he sits down near OPHELIA)*"
  ...
  - os: "Enter PROLOGUE"
    ms: "The PROLOGUE—the actor who will introduce the play—enters."
  ...
  - os: "Enter PLAYER KING and PLAYER QUEEN"
    ms: "Actors playing the roles of KING and QUEEN enter."
  ...
  - os: "The PLAYER KING sleeps"
    ms: "The PLAYER KING sleeps."
  ...
  - os: "Exit PLAYER QUEEN"
    ms: "The PLAYER QUEEN exits."
  ...
  - os: "CLAUDIUS stands up"
    ms: "CLAUDIUS stands up."
  ...
  - os: "  Commotion. Exeunt all but HAMLET and HORATIO"
    ms: "Everyone except HAMLET and HORATIO exits."
  ...
  - os: "Enter ROSENCRANTZ and GUILDENSTERN"
    ms: "ROSENCRANTZ and GUILDENSTERN enter."
  ...
  - os: "Reenter the PLAYERS with recorders"
    ms: "The PLAYERS enter with recorders ."
  ...
  - c: HAMLET
    ...
    m:
      - "Yes, eventually, but as the proverb goes, “While the grass grows …” But that's a tired old proverb. Oh, the recorders! Let me see one.*(he takes a recorder and turns to GUILDENSTERN)* Why are you hovering so close, as if you want to ambush me?"
  ...
  - os: "Exeunt all but HAMLET"
    ms: "Everyone except HAMLET exits."
