...
succ: act-3-scene-1
text:
  - os: "A room in LEONTES ' palace."
    ms: "A room in LEONTES 'S palace."

  - os: "Enter LEONTES, ANTIGONUS, Lords, and Servants"
    ms: "LEONTES, ANTIGONUS, a Lord, and Servants enter."
  ...
  - os: "Enter PAULINA, with a child"
    ms: "PAULINA enters, with a child."
  ...
  - os: "Laying down the child"
    ms: "She lays the child down."
  ...
  - c: LEONTES
    o:
      - "*(to Antigonus)* Thou, traitor, hast set on thy wife to this."
  ...
  - os: "Exit with the child"
    ms: "He exits with the child."
