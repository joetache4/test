...
succ: act-4-scene-1
text:
  - os: "Enter GERTRUDE and POLONIUS"
    ms: "GERTRUDEand POLONIUS enter."
  ...
  - os: "POLONIUS hides behind the arras"
    ms: "POLONIUS hides behind the tapestry."
  ...
  - os: "*(stabs his sword through the arras and kills POLONIUS)*"
    ms: "*(he stabs his sword through the tapestry and kills POLONIUS)*"
  ...
  - os: "*(draws back the arras and discovers POLONIUS)*"
    ms: "*(he pulls back the tapestry and discovers POLONIUS)*"
  ...
  - os: "Exeunt, HAMLET tugging in POLONIUS"
    ms: "They exit, HAMLET dragging POLONIUS offstage."
---