...
succ: act-1-scene-2
text:
  - os: "Enter KENT, GLOUCESTER, and EDMUND"
    ms: "KENT, GLOUCESTER, and EDMUND enter."
  ...
  - os: "Sennet."
    ms: "Trumpets announce the arrival of King LEAR."
  ...
  - os: "Enter one bearing a coronet, then King LEAR, then the Dukes of CORNWALL and ALBANY, next GONERIL, REGAN, CORDELIA, and attendants"
    ms: "A man bearing a crown enters, followed by KING LEAR, the Dukes of CORNWALL and ALBANY, then GONERIL, REGAN, CORDELIA, and attendants."
  ...
  - os: "Exeunt several attendants"
    ms: "Several attendants exit."
  ...
  - os: "Flourish. Enter GLOUCESTER with the King of FRANCE, the Duke of BURGUNDY, and attendants"
    ms: "Trumpets play. GLOUCESTER enters with the King of FRANCE, the Duke of BURGUNDY, and attendants."
  ...
  - os: "Exeunt all but FRANCE, GONERIL, REGAN, and CORDELIA"
    ms: "Everyone exits except FRANCE, GONERIL, REGAN, and CORDELIA."
  ...
  - os: "Exeunt FRANCE and CORDELIA"
    ms: "FRANCE and CORDELIA exit."
