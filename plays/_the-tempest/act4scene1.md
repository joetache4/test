...
succ: act-5-scene-1
text:
  - os: "Enter PROSPERO, FERDINAND, and MIRANDA"
    ms: "PROSPERO, FERDINAND, and MIRANDA enter."
  ...
  - os: "JUNO descends above"
    ms: "JUNO enters above the stage and slowly begins to descend."
  ...
  - os: "JUNO descends to the stage"
    ms: "JUNO comes down to the stage."
  ...
  - os: "JUNO and CERES whisper, and send IRIS on employment"
    ms: "JUNO and CERES whisper, then send IRIS on a mission."
  ...
  - os: "Enter certain nymphs"
    ms: "Several NYMPHS enter."
  ...
  - os: "Enter certain reapers, properly habited They join with the nymphs in a graceful dance towards the end whereof PROSPERO starts suddenly and speaks."
    ms: "Several fieldworkers enter, dressed appropriately. They join the nymphs in a graceful dance. At the end PROSPERO suddenly acts startled and speaks."
  ...
  - os: "To a strange, hollow, and confused noise, the spirits heavily vanish"
    ms: "The dancers vanish sadly to a strange, hollow, and confused noise."
  ...
  - os: "Exeunt FERDINAND and MIRANDA"
    ms: "They exit."
  ...
  - os: "Enter ARIEL, loaden with glistering apparel, etc."
    ms: "ARIEL enters, loaded with sparkling clothes."
  ...
  - os: "Enter CALIBAN, STEPHANO, and TRINCULO, all wet"
    ms: "CALIBAN, STEPHANO, and TRINCULO enter all wet."
  ...
  - os: "A noise of hunters heard Enter divers spirits, in shape of dogs and hounds, hunting them about, PROSPERO and ARIEL setting them on"
    ms: "A noise of hunters is heard. Various spirits enter disguised as dogs and hounds, chasing STEPHANO, TRINCULO, and CALIBAN around. PROSPERO and ARIEL follow them, urging the dogs on."
  ...
  - os: "Spirits drive out CALIBAN, STEPHANO, and TRINCULO"
    ms: "CALIBAN, STEPHANO, and TRINCULO are chased away."
