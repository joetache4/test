...
succ: act-3-scene-3
text:
  - os: "Enter NYM, BARDOLPH, PISTOL, and BOY"
    ms: "NYM, BARDOLPH, PISTOL, and the BOY enter."
  ...
  - os: "Exeunt all but BOY"
    ms: "Everyone but the BOY exits."
  ...
  - os: "Enter FLUELLEN and GOWER"
    ms: "FLUELLEN enters, with GOWER following."
  ...
  - os: "Enter Captain MACMORRIS and Captain JAMY"
    ms: "Captain MACMORRIS and Captain JAMY enter."
  ...
  - os: "A parley sounds"
    ms: "A trumpet tune that indicates a request for a ceasefire sounds."
