...
succ: act-5-scene-4
text:
  - os: "Enter RICHARD, in arms, with NORFOLK, RATCLIFFE, SURREY, and soldiers"
    ms: "RICHARD, dressed in his armor, enters with NORFOLK, SURREY, and others."
  ...
  - os: "Enter RICHMOND, Sir William Brandon, OXFORD, DORSET, HERBERT, BLUNT, and others. Some of the soldiers pitch RICHMOND's tent"
    ms: "RICHMOND, Sir William Brandon, OXFORD, DORSET, HERBERT, BLUNT, and others enter on the other side of the stage. Some soldiers pitch RICHMOND's tent."
  ...
  - os: "He hands him a paper"
    ms: "He hands him a paper"
  ...
  - os: "Enter, to his tent, RICHARD, NORFOLK, RATCLIFFE, CATESBY, and others"
    ms: "RICHARD, NORFOLK, RATCLIFFE, CATESBY, and others enter in RICHARD's tent."
  ...
  - os: "Exeunt Ratcliffe and the other attendants. RICHARD sleeps."
    ms: "RATCLIFFE and the other attendants exit. RICHARD sleeps."

  - os: "Enter STANLEY to RICHMOND in his tent, lords and others attending"
    ms: "STANLEY enters and goes to RICHMOND's tent, where lords and others are waiting on him."
  ...
  - os: "Exeunt all but RICHMOND"
    ms: "Everyone exits except RICHMOND."
  ...
  - os: "Enter the GHOST OF PRINCE EDWARD, son to KING HENRY VI"
    ms: "The GHOST OF PRINCE EDWARD, King Henry VI's son, enters."

  - c: GHOST OF PRINCE EDWARD
    o:
  ...
  - os: "Enter the GHOST OF KING HENRY VI"
    ms: "The GHOST OF KING HENRY VI enters."

  - c: GHOST OF KING HENRY VI
    o:
  ...
  - os: "Enter the GHOST OF CLARENCE"
    ms: "The GHOST OF CLARENCE enters."
  ...
  - os: "Enter the GHOSTS OF RIVERS, GRAY, and VAUGHAN"
    ms: "The GHOSTS of RIVERS, GRAY, and VAUGHAN enter."
  ...
  - os: "Enter the GHOSTS OF the two young PRINCES"
    ms: "The GHOSTS OF the two young PRINCES enter."
  ...
  - os: "Enter the GHOST OF HASTINGS"
    ms: "The GHOST OF HASTINGS enters."
  ...
  - os: "Enter the GHOST OF ANNE"
    ms: "The GHOST OF ANNE enters."
  ...
  - os: "Enter the GHOST OF BUCKINGHAM"
    ms: "The GHOST OF BUCKINGHAM enters."

  - c: GHOST OF BUCKINGHAM
    o:
  ...
  - os: "RICHARD starts out of his dream"
    ms: "RICHARD starts up out of his dream."
  ...
  - os: "Enter the lords to RICHMOND, sitting in his tent"
    ms: "RICHMOND's LORDS enter his tent and go to where he is sitting."
  ...
  - os: "Enter King RICHARD, RATCLIFFE, attendants and forces"
    ms: "RICHARD, RATCLIFFE, attendants, and soldiers enter."
  ...
  - os: "The clock striketh"
    ms: "The clock strikes."
  ...
  - os: "He sheweth him a paper"
    ms: "He shows RICHARD a piece of paper."
