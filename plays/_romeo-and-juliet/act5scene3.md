...
succ:
text:
  - os: "Enter PARIS and his PAGE"
    ms: "PARIS enters with his PAGE."
  ...
  - os: "PAGE extinguishes torch, gives PARIS flowers"
    ms: "The PAGE puts out the torch and gives PARIS the flowers."
  ...
  - os: "PARIS moves away from the tomb Enter ROMEO and BALTHASAR"
    ms: "PARIS hides in the darkness. ROMEO and BALTHASAR enter with a torch, a pickax, and an iron crowbar."
  ...
  - os: "BALTHASAR moves aside, falls asleep"
    ms: "BALTHASAR moves aside and falls asleep."
  ...
  - os: "ROMEO and PARIS fight"
    ms: "ROMEO and PARIS fight."
  ...
  - os: "ROMEO opens the tomb to reveal JULIET inside"
    ms: "ROMEO opens the tomb to reveal JULIET inside."
  ...
  - os: "Enter FRIAR LAWRENCE with lantern, crow, and spade"
    ms: "FRIAR LAWRENCE enters with a lantern, crowbar, and shovel."
  ...
  - os: "A noise sounds from outside the tomb"
    ms: "A noise sounds from outside the tomb."
  ...
  - os: "Exit FRIAR LAWRENCE"
    ms: "FRIAR LAWRENCE exits."
  ...
  - os: "Enter WATCHMEN and PARIS's PAGE"
    ms: "WATCHMEN and PARIS's PAGE enter."
  ...
  - os: "Exeunt some WATCHMEN"
    ms: "Some WATCHMEN exit."
  ...
  - os: "Exeunt more WATCHMEN"
    ms: "Some other WATCHMEN exit in several directions."
  ...
  - os: "Reenter SECOND WATCHMAN with ROMEO's man BALTHASAR"
    ms: "The SECOND WATCHMAN reenters with BALTHASAR."
  ...
  - os: "Reenter THIRD WATCHMAN with FRIAR LAWRENCE"
    ms: "The THIRD WATCHMAN reenters with FRIAR LAWRENCE."
  ...
  - os: "Enter the PRINCE with ATTENDANTS"
    ms: "The PRINCE enters with ATTENDANTS."
  ...
  - os: "Enter CAPULET and LADY CAPULET"
    ms: "CAPULET and LADY CAPULET enter."
