...
succ: act-5-scene-1
text:
  - os: "Enter KING Henry, his sons Thomas Duke of CLARENCE and Humphrey Duke of GLOUCESTER, with WARWICK and others"
    ms: "KING Henry, his sons Thomas Duke of CLARENCE and Humphrey Duke of GLOUCESTER, WARWICK, and others enter."
  ...
  - os: "Enter WESTMORELAND"
    ms: "WESTMORELAND enters."
  ...
  - c: KING
    o:
      ...
      - "She either gives a stomach and no food—	      - Such are the poor, in health—or else a feast"
  ...
  - os: "They carry the KING to a bed."
    ms: "They carry the KING to a bed."
  ...
  - os: "Enter PRINCE HENRY"
    ms: "PRINCE HENRY enters."
  ...
  - os: "Exeunt all but PRINCE HENRY"
    ms: "Everyone exits except PRINCE HENRY."
  ...
  - os: "Enter WARWICK, GLOUCESTER, CLARENCE, and the rest"
    ms: "WARWICK, GLOUCESTER, CLARENCE, and the rest enter."
  ...
  - os: "Exeunt all but the KING and PRINCE HENRY"
    ms: "Everyone leaves except the KING and PRINCE HENRY."
  ...
  - c: PRINCE HENRY
    o:
      - "My gracious liege,"
      - "You won it, wore it, kept it, gave it me.	      - Then plain and right must my possession be,"
  ...
  - os: "Enter Lord John of LANCASTER"
    ms: "Lord John of LANCASTER enters."
  ...
  - os: "Enter WARWICK and others"
    ms: "WARWICK and others enter."
