...
succ: act-3-scene-3
text:
  - os: "Enter BASSANIO, PORTIA, GRATIANO, NERISSA, and all their trains, including a SINGER"
    ms: "BASSANIO, PORTIA, GRATIANO, and NERISSA enter with all their attendants, including a SINGER."
  ...
  - os: "A song, the whilst BASSANIO comments on the caskets to himself"
    ms: "A song plays while BASSANIO mulls over the boxes."
  ...
  - os: "Enter LORENZO, JESSICA, and SALERIO, a messenger from Venice"
    ms: "LORENZO and JESSICA enter with SALERIO, a messenger from Venice."
  ...
  - os: "BASSANIO opens the letter and reads it"
    ms: "BASSANIO opens the letter and reads it."
